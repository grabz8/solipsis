...
namespace Solipsis 
{
    ...
    */
    ...
    protected:
        ...
        void onWorldPressed(const NaviData& naviData);
        void onConnectPressed(const NaviData& naviData);
        void onOptionsPressed(const NaviData& naviData);
        void onQuitPressed(const NaviData& naviData);
