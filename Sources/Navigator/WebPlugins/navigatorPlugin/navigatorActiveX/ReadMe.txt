========================================================================
    ACTIVE TEMPLATE LIBRARY : navigatorActiveX Project Overview
========================================================================

AppWizard has created this navigatorActiveX project for you to use as the starting point for
...
_navigatorActiveX.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_navigatorActiveX.h)
        GUID definitions                                (_navigatorActiveX_i.c)
        A type library                                  (_navigatorActiveX.tlb)
        Marshaling code                                 (_navigatorActiveX_p.c and dlldata.c)
navigatorActiveX.cpp
    This file contains the object map and the implementation of your DLL's exports.
navigatorActiveX.rc
    This is a listing of all of the Microsoft Windows resources that the
    program uses.

navigatorActiveX.def
...
StdAfx.h, StdAfx.cpp
    ...
    named navigatorActiveX.pch and a precompiled types file named StdAfx.obj.
...
navigatorActiveXps.vcproj
	...
	dlldata.c, navigatorActiveX_i.c and navigatorActiveX_p.c which are required
	to build the proxy/stub DLL.

navigatorActiveXps.def
    This module definition file provides the linker with information about the exports
...
Other notes:
	...
	regsvr32 /s /c "navigatorActiveX.dll"
/////////////////////////////////////////////////////////////////////////////
