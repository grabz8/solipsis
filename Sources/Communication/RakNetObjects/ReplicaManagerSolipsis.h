...
#ifndef __REPLICA_MANAGER_SOLIPSIS_H
#define __REPLICA_MANAGER_SOLIPSIS_H
...
/// \ingroup REPLICA_MANAGER_2_GROUP
class ReplicaManager2 : public PluginInterface
{
public:
	/// Constructor
	ReplicaManager2();
    ...
    void SendConstruction(Replica2 *replica, RakNet::BitStream *replicaData, SystemAddress recipient, RakNetTime timestamp, bool sendMessage,
	...
	/// \pre Call SetConnectionFactory() with a derived instance of Connection_RM2Factory.
	void SendDestruction(Replica2 *replica, RakNet::BitStream *replicaData, SystemAddress recipient, RakNetTime timestamp, bool sendMessage,
		DataStructures::OrderedList<SystemAddress,SystemAddress> &exclusionList,
	...
	/// \pre Call SetConnectionFactory() with a derived instance of Connection_RM2Factory.
	void SendSerialize(Replica2 *replica, RakNet::BitStream *replicaData, SystemAddress recipient, RakNetTime timestamp,
		DataStructures::OrderedList<SystemAddress,SystemAddress> &exclusionList,
	...
	/// \pre Call SetConnectionFactory() with a derived instance of Connection_RM2Factory.
	void SendVisibility(Replica2 *replica, RakNet::BitStream *replicaData, SystemAddress recipient, RakNetTime timestamp,
		DataStructures::OrderedList<SystemAddress,SystemAddress> &exclusionList,
	...
	/// \internal
	static int Replica2ObjectComp( Replica2 * const &key, Replica2 * const &data );
	/// \internal
	static int Replica2CompByNetworkID( const NetworkID &key, Replica2 * const &data );
	/// \internal
	static int Connection_RM2CompBySystemAddress( const SystemAddress &key, Connection_RM2 * const &data );
...
/// \ingroup REPLICA_MANAGER_2_GROUP
class Replica2 : public NetworkIDObject
{
public:
	/// Constructor
	Replica2();
...
protected:
	...
	virtual Replica2 * ReceiveConstructionReply(SystemAddress sender, RakNet::BitStream *replicaData, bool constructionAllowed);
...
// GREG BEGIN
    bool ReplicaIsConstructed(Replica2* replica) const; // GREG
// GREG END
