...
void SerializeParamHeader(char *out, unsigned int paramLength, unsigned int *writeOffset, bool IsReal, bool endianSwap);

/// \internal
/// Writes each paramter on the stack with memcpy
void SerializeParamData(char *out, void *paramData, unsigned int paramLength, unsigned int *writeOffset, bool endianSwap);
