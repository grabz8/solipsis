...
/// \internal
void GenRPC::Push( char*& p, char*const i) {
...
/// \internal
void GenRPC::Push( char*& p, const char*const i ) {
	size_t len = strlen( i ) + 1;		
	memcpy( (void*)p, i, len );
	p += len;
}
...
void GenRPC::SerializeParamHeader(char *out, unsigned int paramLength, unsigned int *writeOffset, bool isFloatOrDouble, bool endianSwap)
{
...
void GenRPC::SerializeParamData(char *out, void *paramData, unsigned int paramLength, unsigned int *writeOffset, bool endianSwap)
{
	(void) endianSwap;
