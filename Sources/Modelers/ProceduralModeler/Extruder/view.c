 ...
 */
void uview_direction_ogre (gleDouble m[4][4],	/* returned */
 ...
 */
void uview_dire_ogre (float m[4][4],		/* returned */
                 float v21[3],		/* input */
                 float up[3])		/* input */
{
   gleDouble theta;
 ...
 * vector.
 */
void uviewpoint_ogre (gleDouble m[4][4],		/* returned */
                 ...
                 gleDouble up[3])		/* input */
{
   ...
   uview_direction_ogre (rot_mat, v_hat_21, up);
