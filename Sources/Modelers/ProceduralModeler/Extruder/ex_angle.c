...
void up_sanity_check_ogre (gleDouble up[3],	/* up vector for contour */
...
void extrusion_angle_join_ogre (int ncp,		/* number of contour points */
                           gleDouble** contour,	/* 2D contour */
                           gleDouble** cont_normal, /* 2D normal vecs */
                           ...
                           gleDouble*** xform_array)  /* 2D contour xforms */
{
   ...
   (void) up_sanity_check_ogre (yup, npoints, point_array);
   ...
   while (inext<npoints-1) {
      ...
      uviewpoint_ogre (m, point_array[i], point_array[inext], yup);
      PUSHMATRIX ();
      MULTMATRIX (m);
      ...
      if ((xform_array == NULL) && (!__TUBE_DRAW_PATH_EDGE_NORMALS)) {
         if (color_array == NULL) {
            if (cont_normal == NULL) {
               draw_segment_plain_ogre (ncp, (gleVector *) front_loop,
                                        (gleVector *) back_loop, inext, len_seg);
            } else
            if (__TUBE_DRAW_FACET_NORMALS) {
               draw_segment_facet_n_ogre (ncp, (gleVector *) front_loop,
                                          (gleVector *) back_loop,
                                          (gleVector *) norm_loop, inext, len_seg);
            } else {
               draw_segment_edge_n_ogre (ncp, (gleVector *) front_loop,
                                         (gleVector *) back_loop,
                                         (gleVector *) norm_loop, inext, len_seg);
            }
         } else {
            if (cont_normal == NULL) {
               draw_segment_color_ogre (ncp, (gleVector *) front_loop,
                                        (gleVector *) back_loop,
                                   color_array[inext-1],
                                   color_array[inext], inext, len_seg);
            } else
            if (__TUBE_DRAW_FACET_NORMALS) {
               draw_segment_c_and_facet_n_ogre (ncp,
               ...
               draw_segment_c_and_edge_n_ogre (ncp,
                                   (gleVector *) front_loop,
                                   (gleVector *) back_loop,
                                   (gleVector *) norm_loop,
                                   color_array[inext-1],
         ...
         if (color_array == NULL) {
            ...
            if (__TUBE_DRAW_FACET_NORMALS) {
               draw_binorm_segment_facet_n_ogre (ncp, (gleVector *) front_loop,
                                                 (gleVector *) back_loop,
                                                 (gleVector *) front_norm,
                                                 (gleVector *) back_norm,
                                                 inext, len_seg);
            } else {
               draw_binorm_segment_edge_n_ogre (ncp, (gleVector *) front_loop,
                                                (gleVector *) back_loop,
                                                (gleVector *) front_norm,
                                                (gleVector *) back_norm,
                                                inext, len_seg);
            ...
            if (__TUBE_DRAW_FACET_NORMALS) {
               draw_binorm_segment_c_and_facet_n_ogre (ncp,
                                   (gleVector *) front_loop,
                                   (gleVector *) back_loop,
                                   (gleVector *) front_norm,
                                   (gleVector *) back_norm,
               ...
               draw_binorm_segment_c_and_edge_n_ogre (ncp,
                                   (gleVector *) front_loop,
                                   (gleVector *) back_loop,
                                   (gleVector *) front_norm,
                                   (gleVector *) back_norm,
