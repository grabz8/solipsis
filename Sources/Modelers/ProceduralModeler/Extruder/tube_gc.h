...
extern gleGCOgre *_gle_gc_ogre;
extern gleGCOgre * gleCreateGCOgre (void);

#define INIT_GC_OGRE() {if (!_gle_gc_ogre) { _gle_gc_ogre = gleCreateGCOgre(); atexit (gleDestroyGCOgre);} }
#define extrusion_join_style (_gle_gc_ogre->join_style)

#define __TESS_SLICES (_gle_gc_ogre->slices)
#define __TESS_CIRCLE (_gle_gc_ogre->circle)
#define __TESS_NORM   (_gle_gc_ogre->norm)
