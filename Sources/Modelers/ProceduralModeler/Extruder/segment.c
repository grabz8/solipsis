...
void draw_segment_plain_ogre (int ncp,	/* number of contour points */
...
void draw_segment_color_ogre (int ncp,	/* number of contour points */
                         gleDouble front_contour[][3],	
                         gleDouble back_contour[][3],	
                         gleColor color_last,
                         gleColor color_next,
...
void draw_segment_edge_n_ogre (int ncp,	/* number of contour points */
                           gleDouble front_contour[][3],	
                           gleDouble back_contour[][3],	
                           double norm_cont[][3],
                           int inext, double len)
...
void draw_segment_c_and_edge_n_ogre (int ncp,	/* number of contour points */
                           gleDouble front_contour[][3],	
                           gleDouble back_contour[][3],	
                           double norm_cont[][3],
                           gleColor color_last,
...
void draw_segment_facet_n_ogre (int ncp,	/* number of contour points */
                           gleDouble front_contour[][3],	
                           gleDouble back_contour[][3],	
                           double norm_cont[][3],
                           int inext, double len)
...
void draw_segment_c_and_facet_n_ogre (int ncp,	/* number of contour points */
                           gleDouble front_contour[][3],	
                           gleDouble back_contour[][3],	
                           double norm_cont[][3],
                           gleColor color_last,
...
void draw_binorm_segment_edge_n_ogre (int ncp,      /* number of contour points */
...
void draw_binorm_segment_c_and_edge_n_ogre (int ncp,	/* number of contour points */
                           double front_contour[][3],	
                           double back_contour[][3],	
                           double front_norm[][3],
                           double back_norm[][3],
...
void draw_binorm_segment_facet_n_ogre (int ncp,      /* number of contour points */
                           double front_contour[][3],
                           double back_contour[][3],
                           double front_norm[][3],
                           double back_norm[][3],
...
void draw_binorm_segment_c_and_facet_n_ogre (int ncp,
                           double front_contour[][3],	
                           double back_contour[][3],	
                           double front_norm[][3],
                           double back_norm[][3],
