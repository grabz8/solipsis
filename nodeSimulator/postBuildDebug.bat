...
if not exist "%dst%\XMLRPCP2NServer.dll" xcopy "..\Dependencies\protocols\P2NServer\xmlrpc++\DebugDLL\XMLRPCP2NServer.dll" "%dst%" /s /y
if not exist "%dst%\ULXMLRPCPPP2NServer.dll" xcopy "..\Dependencies\protocols\P2NServer\ulxmlrpcpp\DebugDLL\ULXMLRPCPPP2NServer.dll" "%dst%" /s /y
