...
%% Author and Affiliation (multiple authors with multiple affiliations)
 ...
 \and R. Piegay \thanks{e-mail: romain.piegay@orange-ftgroup.com}\\ %
 			\scriptsize Orange Labs \\%
 \and A.-M. Kermarrec \thanks{e-mail: Anne-Marie.Kermarrec@irisa.fr}\\ %
 			\scriptsize INRIA Rennes \\%	
 \and E. Anceaume \thanks{e-mail: emmanuelle.anceaume@irisa.fr}\\ %
 			\scriptsize IRISA Rennes\\%
 \and F. Le Fessant \thanks{e-mail: fabrice.le\_fessant@inria.fr}\\ %
 			\scriptsize INRIA Paris \\%				
}
