...
%			\scriptsize IRISA \\%
%\and Fabrice Le Fessant \thanks{e-mail: Fabrice.Le_fessant@inria.fr}\\ %
%			\scriptsize IRISA \\%				
}
...
\newcommand{\sol}{Solipsis }
\newcommand{\ptp}{peer-to-peer }
%\newcommand{\df}[1]{\footnote{\textbf{Davide: }#1}}
%\newcommand{\jr}[1]{\footnote{\textbf{Jerome: }#1}}
\newcommand{\df}[1]{}
\newcommand{\jr}[1]{}
