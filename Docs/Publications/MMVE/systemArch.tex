...
\hline
  ...
  \hline
\end{tabular}
\caption{Example of a simple descriptor}
\label{tab:desc}
\end{table}
...
the distance between the corresponding points this
...
site node that is closest to this position. This node then reacts by
