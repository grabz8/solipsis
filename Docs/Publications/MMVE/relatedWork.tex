...
use to encode simple 3D contents in order to visualize them on web
...
size, but especially on its distance from the viewpoint. Many solution
...
have recentky known a tremendous craze from the public. The first
