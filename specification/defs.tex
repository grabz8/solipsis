...
tracks the evolution of an object. For this reason, each descriptor
also contains a sequence number that is incremented each time the
descriptor is modified by the object's owner.
