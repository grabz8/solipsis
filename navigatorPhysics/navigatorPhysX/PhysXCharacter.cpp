...
//-------------------------------------------------------------------------------------
void PhysXCharacter::create(SceneNode* node, Desc& desc)
{
...
//    capsuleControllerDesc.userData = (void*)node;
...
/*    SceneNode* node = (SceneNode*)mNxCapsuleController->getUserData();
    NxExtendedVec3 newPos = mNxCapsuleController->getFilteredPosition();
    node->setPosition(newPos.x, newPos.y - (mDesc.height - mDesc.radius), newPos.z);*/
