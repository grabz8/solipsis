/**************************************************************************
    ...
    $Id: ulxr_valueparse_base.cpp 940 2006-12-30 18:22:05Z ewald-arnold $
...
ULXR_API_IMPL(void) ValueParserBase::ValueState::takeValue(Value *val)
{
...
ULXR_API_IMPL(void) ValueParserBase::MemberState::takeValue(Value *v)
{
...
ULXR_API_IMPL(void) ValueParserBase::ArrayState::takeValue(Value *v)
{
