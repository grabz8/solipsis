 ...
 *
 *	Some people, then, use a typedef to handle both points & vectors using the same class: typedef Point Ogre::Vector3;
 ...
 *
 *	One way to handle it at compile-time would be to use different classes for Point & Ogre::Vector3, only overloading operator "-" for vectors.
