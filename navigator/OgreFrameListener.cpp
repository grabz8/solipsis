...
{
    mKeyListenersStack.push(mKeyboard->getEventCallback());
    mMouseListenersStack.push(mMouse->getEventCallback());
...
{
    mKeyboard->setEventCallback(mKeyListenersStack.top());
    mMouse->setEventCallback(mMouseListenersStack.top());
