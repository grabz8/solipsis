...
@set SRC_DIR_OPT="C:\Work\mozilla181\mozilla\objdir-opt-xulrunner-small"
@set SRC_DIR_DEBUG="C:\Work\mozilla181\mozilla\objdir-debug-xulrunner-small"
...
xcopy xulrunner.js												%DEST_DIR%\runtime_debug\defaults\pref\ /s
...
xcopy xulrunner.js												%DEST_DIR%\runtime_release\defaults\pref\ /s
