/***************************************************************************
    ...
    $Id: ulxr_valueparse_wb.h 940 2006-12-30 18:22:05Z ewald-arnold $
...
/** Helper class to represent the data of the current parsing step
  * when the xml element is an Boolean
  */
  class ULXR_API_DECL0 BooleanState : public ValueParserBase::ValueState
  {
   public:
   ...
   private:
     BooleanState(const BooleanState&); // forbid this
     BooleanState& operator= (const BooleanState&);
  };

  friend class IntegerState;
  friend class BooleanState;
