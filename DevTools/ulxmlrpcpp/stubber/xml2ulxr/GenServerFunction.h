...
#ifndef GENSERVERFUNCTION_H
#define GENSERVERFUNCTION_H
...
class GenerateServerFunctions : public GenerateMethod
{
  public:

    GenerateServerFunctions(const std::vector<Method> &methods);
