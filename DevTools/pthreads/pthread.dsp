...
SOURCE="$(InputPath)"
PostBuild_Cmds=if not exist ..\..\Dependencies\pthreads\include mkdir ..\..\Dependencies\pthreads\include	copy pthread.h ..\..\Dependencies\pthreads\include /y	copy sched.h ..\..\Dependencies\pthreads\include /y	copy semaphore.h ..\..\Dependencies\pthreads\include /y	if not exist ..\..\Dependencies\pthreads\lib mkdir ..\..\Dependencies\pthreads\lib	copy pthreadVC.lib ..\..\Dependencies\pthreads\lib\pthreadVC.lib /y	copy pthreadVC.dll ..\..\Dependencies\pthreads\lib\pthreadVC.dll /y
...
# ADD LINK32 kernel32.lib user32.lib ws2_32.lib /nologo /dll /map /debug /machine:I386 /out:".\pthreadVC_d.dll" /pdbtype:sept
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=if not exist ..\..\Dependencies\pthreads\include mkdir ..\..\Dependencies\pthreads\include	copy pthread.h ..\..\Dependencies\pthreads\include /y	copy sched.h ..\..\Dependencies\pthreads\include /y	copy semaphore.h ..\..\Dependencies\pthreads\include /y	if not exist ..\..\Dependencies\pthreads\lib mkdir ..\..\Dependencies\pthreads\lib	copy pthreadVC_d.lib ..\..\Dependencies\pthreads\lib\pthreadVC_d.lib /y	copy pthreadVC_d.dll ..\..\Dependencies\pthreads\lib\pthreadVC_d.dll /y
# End Special Build Tool
