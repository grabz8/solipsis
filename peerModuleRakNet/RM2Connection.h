...
*/
class RM2Connection : public RakNet::Connection_RM2
{
...
*/
class RM2ConnectionFactory : public RakNet::Connection_RM2Factory
{
    /** See Connection_RM2Factory::AllocConnection. */
	virtual RakNet::Connection_RM2* AllocConnection(void) const { return new RM2Connection; }
