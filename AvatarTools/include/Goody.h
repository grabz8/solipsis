...
/// brief This is the class representing a goody of an avatar. A goody is an accessory, which will be attached to a bone of the mesh of the Avatar. The goody will be represented by any of its GoodyModel (It has a collection of GoodyModels). For example, we can have a Goody named "Watch" and GoodyModel "Rolex","Swatch"...  The user will be able to move this Goody and orientate as he wants. He will also able to change his colour, if the xml nature file allows it, which will be taken as the colour of the submesh 0 of the mesh of the current GoodyModel used to represent the Goody. Same thing for the texture.
/// file Goody.h
...
public:
	...
	///param owner Avatar to which the Goody belongs.
	...
	///brief Method which gives the Avatar to which the Goody belongs.
	///return The Avatar to which the Goody belongs.
	Character* getOwner();



	///brief Method which return the name of the bone of the Avatar to which the Goody is attached.
	///return The name of the bone of the Avatar to which the Goody is attached.
	...
	///brief Method which update the position at the screen of the Goody according to the concerned Avatar's bone and the current position and rotation. Goody must have a current GoodyModel (different from "None" GoodyModel).
...
private:
	...
	Character* mOwner;													///brief Avatar to which the Goody belongs.

	GoodyModelsMap mGoodyModels;										///brief Map containing all the GoodyModels of the Goody.
	GoodyModelsMap::iterator mCurrentGoodyModelIterator;				///brief Map iterator on the GoodyModels pointing on the current GoodyModel.
	GoodyModelsMap::iterator mDefaultGoodyModelIterator;				///brief Map iterator on the GoodyModels pointing on the default GoodyModel of the Goody (the first found in the avatar .nature xml file).	

	String mBoneName;													///brief Bone of the mesh of the avatar to which the Goody must be attached.
