...
#import <SketchUp.tlb> rename_namespace("SketchUp")
#import <SketchUpReader.dll> rename_namespace("SketchUpReader") named_guids
...
public:
	...
	CVector3d(SketchUp::ISkpVector3dPtr vec);
    ~CVector3d() {}
...
public:
	...
	CPoint3d(SketchUp::ISkpPoint3dPtr point);
    ~CPoint3d() {}
